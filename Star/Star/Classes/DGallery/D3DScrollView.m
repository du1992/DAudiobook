...
- (void)commonInit
{
    ...
    self.effect = D3DScrollViewEffectNone;
}

- (void)setEffect:(DScrollViewEffect)effect
{
    self->_effect = effect;
    
    switch (effect) {
        case D3DScrollViewEffectTranslation:
            self.angleRatio = 0.;
        ...
        case D3DScrollViewEffectDepth:
            ...
            self.translateY = 0.;
            break;
        case D3DScrollViewEffectCarousel:
            self.angleRatio = .5;
