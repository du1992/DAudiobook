...
@interface DIntroductionViewController () <UIScrollViewDelegate>
...
@implementation DIntroductionViewController
...
- (void)viewDidLoad {
    ...
    [self.view sendSubviewToBack:self.pageControl];
    ...
    self.enterButton.backgroundColor=[UIColor colorWithRed:210/255.0 green:1/255.0 blue:255/255.0 alpha:1];
...
{
    return CGRectMake(0, self.view.bounds.size.height-8 , self.view.bounds.size.width, 10);
}
...
- (CGRect)frameOfEnterButton
{
    ...
    if (CGSizeEqualToSize(size, CGSizeZero)) {
        size = CGSizeMake(self.view.frame.size.width * 0.6, 30);
    }
